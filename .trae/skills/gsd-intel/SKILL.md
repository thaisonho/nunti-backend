...
Intel system is disabled. To activate:
  ...
  node ./.trae/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node ./.trae/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node ./.trae/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node ./.trae/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: ./.trae/get-shit-done/bin/gsd-tools.cjs
