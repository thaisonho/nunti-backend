...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ./.trae/get-shit-done
                  → writes to ./.trae/get-shit-done/hooks/
...
@./.trae/get-shit-done/references/thinking-models-debug.md
...
- Read @./.trae/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "./.trae/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "./.trae/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "./.trae/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
