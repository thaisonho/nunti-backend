...
Use template from `./.trae/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `./.trae/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "./.trae/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
