...
<!-- For checkpoint task examples and patterns, see @./.trae/get-shit-done/references/checkpoints.md -->
...
See `./.trae/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `./.trae/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `./.trae/get-shit-done/workflows/verify-phase.md` for verification logic.
