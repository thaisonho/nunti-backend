...
<!-- For checkpoint task examples and patterns, see @./.augment/get-shit-done/references/checkpoints.md -->
...
See `./.augment/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `./.augment/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `./.augment/get-shit-done/workflows/verify-phase.md` for verification logic.
