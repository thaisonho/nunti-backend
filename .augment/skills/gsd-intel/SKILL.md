...
Intel system is disabled. To activate:
  ...
  node ./.augment/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node ./.augment/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node ./.augment/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node ./.augment/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: ./.augment/get-shit-done/bin/gsd-tools.cjs
