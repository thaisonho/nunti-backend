...
<reference>
@./.augment/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `./.augment/get-shit-done/references/user-profiling.md` to load:
