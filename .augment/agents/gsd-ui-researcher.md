...
Use template from `./.augment/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `./.augment/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "./.augment/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
