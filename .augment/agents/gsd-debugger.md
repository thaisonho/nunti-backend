...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ./.augment
                  → checks ./.augment/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ./.augment/get-shit-done
                  → writes to ./.augment/get-shit-done/hooks/
...
@./.augment/get-shit-done/references/thinking-models-debug.md
...
- Read @./.augment/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "./.augment/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "./.augment/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "./.augment/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
