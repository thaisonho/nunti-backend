...
@./.gemini/get-shit-done/references/domain-probes.md
</required_reading>
...
```bash
node "./.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
