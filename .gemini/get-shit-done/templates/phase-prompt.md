...
<!-- For checkpoint task examples and patterns, see @/home/json/hcmus/applied_crypto/nunti-backend/.gemini/get-shit-done/references/checkpoints.md -->
...
See `/home/json/hcmus/applied_crypto/nunti-backend/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/json/hcmus/applied_crypto/nunti-backend/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/json/hcmus/applied_crypto/nunti-backend/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
