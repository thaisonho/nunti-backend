...
Intel system is disabled. To activate:
  ...
  node ./.windsurf/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node ./.windsurf/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node ./.windsurf/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node ./.windsurf/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: ./.windsurf/get-shit-done/bin/gsd-tools.cjs
