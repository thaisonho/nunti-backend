...
<required_reading>
@./.windsurf/get-shit-done/references/domain-probes.md
@./.windsurf/get-shit-done/references/gate-prompts.md
@./.windsurf/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @./.windsurf/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
MAX_PASSES=$(node "./.windsurf/get-shit-done/bin/gsd-tools.cjs" config-get workflow.max_discuss_passes 2>/dev/null || echo "3")
```
...
**Full step-by-step instructions:** @./.windsurf/get-shit-done/workflows/discuss-phase-power.md
