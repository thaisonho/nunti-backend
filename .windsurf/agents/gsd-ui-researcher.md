...
Use template from `./.windsurf/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `./.windsurf/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "./.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
