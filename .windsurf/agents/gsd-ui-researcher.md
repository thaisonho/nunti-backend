...
Use template from `/home/json/hcmus/applied_crypto/nunti-backend/.windsurf/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/json/hcmus/applied_crypto/nunti-backend/.windsurf/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/json/hcmus/applied_crypto/nunti-backend/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
