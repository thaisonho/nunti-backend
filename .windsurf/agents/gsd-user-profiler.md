...
<reference>
@./.windsurf/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `./.windsurf/get-shit-done/references/user-profiling.md` to load:
