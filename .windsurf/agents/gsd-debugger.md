...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ./.windsurf
                  → checks ./.windsurf/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ./.windsurf/get-shit-done
                  → writes to ./.windsurf/get-shit-done/hooks/
...
@./.windsurf/get-shit-done/references/thinking-models-debug.md
...
- Read @./.windsurf/get-shit-done/references/common-bug-patterns.md
...
```bash
node "./.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "./.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
