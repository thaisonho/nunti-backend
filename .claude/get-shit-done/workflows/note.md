...
- **Global scope**: `/home/json/hcmus/applied_crypto/nunti-backend/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/json/hcmus/applied_crypto/nunti-backend/.claude/notes/`)
...
2. Glob `/home/json/hcmus/applied_crypto/nunti-backend/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/json/hcmus/applied_crypto/nunti-backend/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/json/hcmus/applied_crypto/nunti-backend/.claude/notes/` — works in any directory
