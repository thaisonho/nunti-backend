...
Intel system is disabled. To activate:
  ...
  node ./.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node ./.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node ./.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node ./.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
